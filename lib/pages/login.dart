...
import 'package:readerbook/pages/user/user_home_page.dart';
      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (context) => role == 'admin'
              ...
              : UserHomePage(), // Navigate to User Home Page
        ),
      );
    } else {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Logo
                Image.network(
                  'https://png.pngtree.com/png-clipart/20220723/ourmid/pngtree-tumpukan-buku-dan-pensil-png-image_6034249.png', // Ganti dengan URL gambar Anda
                  width: 150,
                  height: 150,
